...
const ParallaxCardCarousel = ({
    ...
    maxRotation = 25,
    parallaxFactor = 0.2,
    backgroundColor = '' // Removed default bg to fit seamless integration
}) => {
        ...
        return (
            <div className="relative w-full h-full">
                ...
                >
                    ...
                    {card.imageUrl && (
                        <motion.div
                            className="my-4 rounded-lg overflow-hidden flex-1"
                            style={{
                    ...
                    <div>
                        ...
                        <button
                            className="px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-lg transition-all duration-300 transform hover:scale-105"
                            onClick={(e) => {
                                e.stopPropagation();
                                card.onAction && card.onAction();
                            }}
                        >
                            {card.actionLabel || 'View Project'}
                        </button>
                    </div>
                </motion.div>
                ...
                {/* Card border */}
                <motion.div
                    className="absolute inset-0 rounded-2xl border border-gray-700 pointer-events-none"
                    style={{
    ...
    return (
        <div className={`flex flex-col items-center justify-center p-4 md:p-10 ${backgroundColor} overflow-hidden`}>
            <div
                ref={carouselRef}
            ...
            >
                ...
                <div className="absolute bottom-0 left-0 right-0 flex justify-center gap-4 py-6 z-20">
                    ...
                    <button
                        className={`p-3 rounded-full backdrop-blur-md transition-colors duration-300 text-white ${isAutoPlaying ? 'bg-white/20' : 'bg-white/10 hover:bg-white/20'
                            }`}
